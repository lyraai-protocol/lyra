  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[var(--container-wrap)] px-6 sm:px-8">
        ...
        >
          Balances, transfers, Cetus swaps, DeepBook orders, NAVI &amp; Scallop lending, DeFiLlama
          discovery, Walrus receipts. Every write passes the gates, gets a permission check, and
          lands in an auditable decision record.
        </motion.p>
      </div>
    </section>
  )
