...
// map that real lyra TG uses. Anything not listed defaults to 🔧.
...
function ChatWallpaper() {
  return (
    ...
    >
      ...
      <rect width="100%" height="100%" fill="url(#lyra-tg-doodle)" />
    </svg>
  )
}

// ─────────── conic-gradient Lyra avatar ───────────

function LyraAvatar({ size = 24 }: { size?: number }) {
  return (
    <div
      style={{
        width: size,
