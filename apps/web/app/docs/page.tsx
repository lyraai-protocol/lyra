...
export const metadata = {
  title: 'docs · lyra',
  description: 'How lyra works, end to end. Install, architecture, the four-gate write pipeline.',
}
    ...
    <article className="min-w-0">
      ...
      <header className="mt-6 flex flex-col gap-5 md:mt-0">
        ...
        <p className="max-w-[60ch] text-[15.5px] leading-relaxed text-[var(--color-ink-2)]">
          A few commands take you from install to a live chat. The chapters that follow walk the
          four-gate write pipeline, the CLI and config reference, and the operator console at /console.
        </p>
      </header>
      ...
      <footer className="mt-20 border-t border-[var(--color-border)] pt-8">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-5 text-[13px]">
          <a
            href="https://github.com/rifkyeasy/lyra#readme"
            target="_blank"
            rel="noreferrer"
